  ...
  form.addEventListener('submit', function (event) {
    ...
    const perguntaSelecionada = document.getElementById('pergunta-secreta').value;
    const respostaPergunta = document.getElementById('resposta-pergunta').value.trim();

    if (!nome || !email || !senha || !confirmarSenha || !perguntaSelecionada || !respostaPergunta) {
    ...
    const novoUsuario = {
      ...
      email,
      senha,
      perguntaRecuperacao: perguntaSelecionada,
